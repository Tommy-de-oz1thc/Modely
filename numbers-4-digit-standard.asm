...
global Radio_numbers_4_digit_standard
extern _strcmp
...
section .data
	...
	%include "db\\numbers-4-digit-standard-db.asm"
...
go_to_txt db "Radio(1), 4 digit(2): ", 0
...
say_sentences db "Say\\say_text.exe You choosed 4 digit", 0
...
Radio_numbers_4_digit_standard:
    push cls_cmd
    call _system
...
pass:
	...
	add esp, 4
	call _getch
    jmp Radio_numbers_4_digit_standard
