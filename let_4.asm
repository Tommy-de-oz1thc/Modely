...
section .data
    ...
    Let_1_info db "Lesson 4 letters", 10, 0
	Let_1_link db "Letters(Esc), 4 Level(1): ", 0
	say_letters db "Say\\say_text.exe You choose Level 4", 0
    sent_cw_txt db "I will sent you 5 random letters from Level 4", 10, 0
