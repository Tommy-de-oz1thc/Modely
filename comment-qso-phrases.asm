...
global Radio_comment_qso_phrases
...
section .data
%include "db\\comment-qso-phrases-db.asm"
...
go_to_txt db "Radio(1), Comment qso phrases(2): ", 0
...
say_sentences db "Say\\say_text.exe You choosed comment qso phrases", 0
