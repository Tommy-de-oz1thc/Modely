...
section .data
    ...
    Let_1_info db "Lesson 11 letters", 10, 0
	Let_1_link db "Letters(Esc), 11 Level(1): ", 0
	say_letters db "Say\\say_text.exe You choose Level 11", 0
    sent_cw_txt db "I will sent you 5 random letters from Level 11", 10, 0
