...
global Radio_numbers_3_digit_standard
extern _strcmp
...
section .data
	...
	%include "db\\numbers-3-digit-standard-db.asm"
...
go_to_txt db "Radio(1), 3 digit(2): ", 0
...
say_sentences db "Say\\say_text.exe You choosed 3 digit", 0
...
Radio_numbers_3_digit_standard:
    push cls_cmd
    call _system
...
pass:
	...
	add esp, 4
	call _getch
    jmp Radio_numbers_3_digit_standard
