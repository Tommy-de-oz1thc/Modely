...
section .data
%include "db\\5-6-letter-words-db.asm"
...
info_txt   db "5-6 letter Words",10,0
go_to_txt db "Words(1), 5-6 letter words(2): ", 0
...
say_words db "Say\\say_text.exe You choose 5 to 6 letter Words", 0
