...
section .data
	...
	%include "db\\dit-challenge-db.asm"
...
go_to_txt db "Radio(1), Dit Challenges(2): ", 0
...
say_sentences db "Say\\say_text.exe You choosed dit challenges", 0
