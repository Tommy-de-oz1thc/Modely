...
info_txt   db "4 words Sentences",10,0
go_to_txt db "Sentences(1), 4 words sentences(2): ", 0
...
say_sentences db "Say\\say_text.exe You choosed 4 words Sentences", 0
