...
section .data
%include "db\\6-letter-words-db.asm"
...
info_txt   db "6 letter Words",10,0
go_to_txt db "Words(1), 6 letter words(2): ", 0
...
say_words db "Say\\say_text.exe You choose 6 letter Words", 0
