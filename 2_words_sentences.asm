...
info_txt   db "2 words Sentences",10,0
go_to_txt db "Sentences(1), 2 words sentences(2): ", 0
...
say_sentences db "Say\\say_text.exe You choosed 2 words Sentences", 0
