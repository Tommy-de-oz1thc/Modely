...
section .data
%include "db\\sentences-from-top-600-words-db.asm"
...
info_txt   db "Sentences from Top 600 Words",10,0
go_to_txt db "Sentences(1), Sentences from Top 600 Words(2): ", 0
...
say_sentences db "Say\\say_text.exe You choosed Sentences from the 600 top words", 0
