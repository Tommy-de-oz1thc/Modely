...
info_txt   db "3 words Sentences",10,0
go_to_txt db "Sentences(1), 3 words sentences(2): ", 0
...
say_sentences db "Say\\say_text.exe You choosed 3 words Sentences", 0
