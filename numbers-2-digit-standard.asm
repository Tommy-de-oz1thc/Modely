...
global Radio_numbers_2_digit_standard
extern _strcmp
...
section .data
	...
	%include "db\\numbers-2-digit-standard-db.asm"
...
info_txt   db "Radio 2 digit",10,0
go_to_txt db "Radio(1), 2 digit(2): ", 0
...
say_sentences db "Say\\say_text.exe You choosed 2 digit", 0
...
Radio_numbers_2_digit_standard:
    push cls_cmd
    call _system
...
pass:
	...
	add esp, 4
	call _getch
    jmp Radio_numbers_2_digit_standard
