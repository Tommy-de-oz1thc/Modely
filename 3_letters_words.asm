...
section .data
%include "db\\3-letter-words-db.asm"
...
info_txt   db "3 Letter Words",10,0
go_to_txt db "Words(1), 3 letter words(2): ", 0
...
say_words db "Say\\say_text.exe You choose 3 letter Words", 0
