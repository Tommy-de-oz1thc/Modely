...
section .data
%include "db\\phrases_7_words-db.asm"
...
info_txt   db "7 words Sentences",10,0
go_to_txt db "Sentences(1), 7 words sentences(2): ", 0
...
say_sentences db "Say\\say_text.exe You choosed 7 words Sentences", 0
