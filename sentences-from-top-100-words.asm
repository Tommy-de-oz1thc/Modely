...
section .data
%include "db\\sentences-from-top-100-words-db.asm"
...
info_txt   db "Sentences from Top 100 Words",10,0
go_to_txt db "Sentences(1), Sentences from Top 100 Words(2): ", 0
...
say_sentences db "Say\\say_text.exe You choosed Sentences from the 100 top words", 0
