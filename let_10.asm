...
section .data
    ...
    Let_1_info db "Lesson 10 letters", 10, 0
	Let_1_link db "Letters(Esc), 10 Level(1): ", 0
	say_letters db "Say\\say_text.exe You choose Level 10", 0
    sent_cw_txt db "I will sent you 5 random letters from Level 10", 10, 0
