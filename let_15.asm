...
section .data
    ...
    word_ptrs dd word1, word2, word3, word4, word5
              ...
              dd word36, word37, word38, word39, word40			  
    ...
    Let_1_info db "Lesson 15 letters", 10, 0
	Let_1_link db "Letters(Esc), 15 Level(1): ", 0
	say_letters db "Say\\say_text.exe You choose Level 15", 0
    sent_cw_txt db "I will sent you 5 random letters from Level 15", 10, 0
