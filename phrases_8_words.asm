...
section .data
%include "db\\phrases_8_words-db.asm"
...
info_txt   db "8 words Sentences",10,0
go_to_txt db "Sentences(1), 8 words sentences(2): ", 0
...
say_sentences db "Say\\say_text.exe You choosed 8 words Sentences", 0
